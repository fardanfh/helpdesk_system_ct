  ...
  <header id="home" style="background-image: url({{ asset('assets/images/landing/img-headerbg.jpg') }})">
    <nav class="navbar navbar-expand-md navbar-light default">
      ...
      src="{{ asset('assets/images/landing/tech-bootstrap.svg') }}" alt="img" class="img-fluid wid-30" />Bootstrap 5</a>
                ...
                <a class="dropdown-item gap-2" href="#" data-bs-toggle="tooltip" data-bs-placement="top"
                  title="Live Preview not available"><img src="{{ asset('assets/images/landing/tech-l-b.svg') }}" alt="img"
                    class="img-fluid wid-30" />Laravel Bootstrap</a>
                <a class="dropdown-item gap-2" href="#" data-bs-toggle="tooltip" data-bs-placement="top"
                  title="Live Preview not available"><img src="{{ asset('assets/images/landing/tech-svelteKit.svg') }}" alt="img"
                                ...
                                <li class="nav-item px-1 dropdown">
                                  ...
                                  <div class="dropdown-menu drp-technology nav-drp-tech-scrollble">
                                    ...
                                    <!-- <a
                                        ...
                                        ><img src="{{ asset('assets/images/landing/tech-figma.svg') }}" alt="img" class="img-fluid wid-30" />Figma</a
                                      > -->
                                  </div>
                                </li>
                        ...
                        <div class="technology-block scrollble-tech-block">
                          <ul class="list-inline mb-0">
                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to Preview Tailwind">
                              <a href="https://ableproadmin.com/tailwind/dashboard/index.html" target="_blank"><img
                                  src="{{ asset('assets/images/landing/tech-tailwind.svg') }}" alt="img" class="img-fluid" /></a>
                            </li>
                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top"
                              title="Click to Preview Bootstrap 5">
                          <a href="dashboard/index.html"><img src="{{ asset('assets/images/landing/tech-bootstrap.svg') }}" alt="img"
                            class="img-fluid" /></a>
                            </li>
                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top"
                              title="Click to Preview React MUI">
                          <a href="https://ableproadmin.com/react/dashboard/default" target="_blank"><img
                            src="{{ asset('assets/images/landing/tech-react.svg') }}" alt="img" class="img-fluid" /></a>
                            </li>
                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top"
                              title="Click to Preview Angular Material">
                          <a href="https://ableproadmin.com/angular/default/dashboard/default" target="_blank"><img
                            src="{{ asset('assets/images/landing/tech-angular.svg') }}" alt="img" class="img-fluid" /></a>
                            </li>
                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top"
                              title="Click to Preview CodeIgniter">
                          <a href="https://ableproadmin.com/codeigniter/default/public/dashboard-default" target="_blank"><img
                            src="{{ asset('assets/images/landing/tech-codeigniter.svg') }}" alt="img" class="img-fluid" /></a>
                            </li>
                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to Preview ASP.net">
                          <a href="https://able-pro.azurewebsites.net/Dashboard/Index" target="_blank"><img
                            src="{{ asset('assets/images/landing/tech-net.svg') }}" alt="img" class="img-fluid" /></a>
                            </li>
                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to Preview NextJS">
                              <a href="https://able-pro-material-next-ts-navy.vercel.app/dashboard/default" target="_blank"><img
                                  src="{{ asset('assets/images/landing/tech-nextjs.svg') }}" alt="img" class="img-fluid" /></a>
                            </li>
                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to Preview Vue">
                              <a href="https://ableproadmin.com/vue/dashboard/default" target="_blank"><img
                                  src="{{ asset('assets/images/landing/tech-vuetify.svg') }}" alt="img" class="img-fluid" /></a>
                            </li>
                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to Preview Vue+Laravel">
                              <a href="https://phplaravel-207002-4524103.cloudwaysapps.com/build/dashboards/default" target="_blank"><img
                                  src="{{ asset('assets/images/landing/tech-l-v.svg') }}" alt="img" class="img-fluid" /></a>
                            </li>
                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top"
                              title="Live Preview not available">
                              <a href="#" target="_blank"><img src="{{ asset('assets/images/landing/tech-django.svg') }}" alt="img"
                                  class="img-fluid" /></a>
                            </li>
                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top"
                              title="Live Preview not available">
                              <a href="#" target="_blank"><img src="{{ asset('assets/images/landing/tech-flask.svg') }}" alt="img" class="img-fluid" /></a>
                            </li>
                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top"
                              title="Live Preview not available">
                              <a href="#" target="_blank"><img src="{{ asset('assets/images/landing/tech-nodejs.svg') }}" alt="img"
                                  class="img-fluid" /></a>
                            </li>
                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top"
                              title="Live Preview not available">
                              <a href="#" target="_blank"><img src="{{ asset('assets/images/landing/tech-l-b.svg') }}" alt="img" class="img-fluid" /></a>
                            </li>
                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top"
                              title="Live Preview not available">
                              <a href="#" target="_blank"><img src="{{ asset('assets/images/landing/tech-svelteKit.svg') }}" alt="img"
                                  class="img-fluid" /></a>
                            </li>
                            <!-- <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Figma Design System">
                                <a
                                  href="https://www.figma.com/file/6XqmRhRmkr33w0EFD49acY/Able-Pro--v9.0-Figma-Preview?type=design&node-id=46-226114&mode=design&t=4FS2Lw6WxsmJ3RLm-0"
                                  target="_blank"
                                  ><img src="{{ asset('assets/images/landing/tech-figma.svg') }}" alt="img" class="img-fluid"
                                /></a>
                              </li> -->
                          </ul>
                        </div>
                        ...
                        <div class="container technology-block">
                          ...
                          <div class="row justify-content-start mb-4 mb-sm-2">
                            <div class="col-md-6 col-lg-4">
                              <div class="card">
                                <div class="card-body">
                                  <img src="{{ asset('assets/images/landing/tech-tailwind.svg') }}" alt="img" class="img-fluid" />
                                  ...
                                  <a class="btn btn-light-dark mt-2" href="https://ableproadmin.com/tailwind/dashboard/index.html"
                                    target="_blank"><i class="ti ti-external-link"></i> Preview</a>
                                  <a class="btn btn-icon btn-light mt-2" target="_blank" data-bs-toggle="tooltip" disabled
                                    data-bs-placement="top" title="Click to Download Free Able Pro Dashboard Template"
                            ...
                            <div class="col-md-6 col-lg-4">
                              <div class="card">
                                <div class="card-body">
                                  <img src="{{ asset('assets/images/landing/tech-bootstrap.svg') }}" alt="img" class="img-fluid" />
                                  <h4 class="mb-3 mt-2">Bootstrap 5</h4>
                                  <p class="text-muted">
                                    Able Pro Bootstrap 5 - the top choice for responsive, mobile-first design, you can achieve both
                                    professional functionality
                                    and visual appeal.
                                  </p>
                                  <a class="btn btn-light-dark mt-2" href="dashboard/index.html" target="_blank"><i
                                      class="ti ti-external-link"></i> Preview</a>
                                  <a class="btn btn-icon btn-light mt-2" target="_blank" data-bs-toggle="tooltip" disabled
                                      data-bs-placement="top" title="Click to Download Free Able Pro Dashboard Template"
                                      href="https://links.codedthemes.com/vYUWM"><i class="ti ti-brand-github"></i></a>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-4">
                              <div class="card">
                                <div class="card-body">
                                  <img src="{{ asset('assets/images/landing/tech-react-1.svg') }}" alt="img" class="img-fluid" />
                                  <h4 class="mb-3 mt-2">React Material-UI</h4>
                                  <p class="text-muted">
                                    Able Pro React dashboard template is a powerful tool that utilizes the Material-UI component library to
                                    create stunning
                            ...
                            <div class="col-md-6 col-lg-4">
                              <div class="card">
                                <div class="card-body">
                                  <img src="{{ asset('assets/images/landing/tech-net.svg') }}" alt="img" class="img-fluid" />
                                  <h4 class="mb-3 mt-2">Asp.net</h4>
                                  <p class="text-muted">
                                    Able Pro .NET version is a robust dashboard template designed specifically for .NET developers. Its
                                    comes with a wide
                                    range of pre-built components.
                                  </p>
                                  <a class="btn btn-light-dark mt-2" href="https://able-pro.azurewebsites.net/Dashboard/Index"
                                    target="_blank"><i class="ti ti-external-link"></i> Preview</a>
                                  <a class="btn btn-icon btn-light mt-2" target="_blank" data-bs-toggle="tooltip" disabled
                                    data-bs-placement="top" title="Click to Download Free Able Pro Dashboard Template"
                                    href="https://links.codedthemes.com/vYUWM"><i class="ti ti-brand-github"></i></a>
                            ...
                            <div class="col-md-6 col-lg-4">
                              <div class="card">
                                <div class="card-body">
                                  <img src="{{ asset('assets/images/landing/tech-codeigniter.svg') }}" alt="img" class="img-fluid" />
                                  <h4 class="mb-3 mt-2">CodeIgniter</h4>
                                  <p class="text-muted">
                                    Able Pro CodeIgniter version is a powerful dashboard template built specifically for developers who use
                                    the CodeIgniter
                                    PHP framework with Bootstrap.
                                  </p>
                                  <a class="btn btn-light-dark mt-2"
                                    href="https://ableproadmin.com/codeigniter/default/public/dashboard-default" target="_blank"><i
                                      class="ti ti-external-link"></i> Preview</a>
                                  <a class="btn btn-icon btn-light mt-2" target="_blank" data-bs-toggle="tooltip" disabled
                                      data-bs-placement="top" title="Click to Download Free Able Pro Dashboard Template"
                                      href="https://links.codedthemes.com/vYUWM"><i class="ti ti-brand-github"></i></a>
                            ...
                            <div class="col-md-6 col-lg-4">
                              <div class="card">
                                <div class="card-body">
                                  <img src="{{ asset('assets/images/landing/tech-angular.svg') }}" alt="img" class="img-fluid" />
                                  <h4 class="mb-3 mt-2">Angular Material</h4>
                                  <p class="text-muted">
                                    Able Pro Angular dashboard template is a powerful tool that utilizes the Google Material component
                                    library to create
                                    stunning and intuitive user interfaces.
                                  </p>
                                  <a class="btn btn-light-dark mt-2" href="https://ableproadmin.com/angular/default/dashboard/default"
                                    target="_blank"><i class="ti ti-external-link"></i> Preview</a>
                                  <a class="btn btn-icon btn-light mt-2" target="_blank" data-bs-toggle="tooltip" disabled
                                    data-bs-placement="top" title="Click to Download Free Able Pro Dashboard Template"
                                    href="https://links.codedthemes.com/vYUWM"><i class="ti ti-brand-github"></i></a>
                            ...
                            <div class="col-md-6 col-lg-4">
                              <div class="card">
                                <div class="card-body">
                                  <img src="{{ asset('assets/images/landing/tech-nextjs.svg') }}" alt="img" class="img-fluid" />
                                  <h4 class="mb-3 mt-2">NextJS</h4>
                                  <p class="text-muted">
                                    Able Pro NextJs dashboard template is a powerful tool that utilizes the Material-UI component library to
                                    create stunning
                                    and intuitive user interfaces.
                                  </p>
                                  <a class="btn btn-light-dark mt-2"
                                    href="https://able-pro-material-next-ts-navy.vercel.app/dashboard/default" target="_blank"><i
                                      class="ti ti-external-link"></i> Preview</a>
                                  <a class="btn btn-icon btn-light mt-2" target="_blank" data-bs-toggle="tooltip" disabled
                                      data-bs-placement="top" title="Click to Download Free Able Pro Dashboard Template"
                                      href="https://links.codedthemes.com/vYUWM"><i class="ti ti-brand-github"></i></a>
                            ...
                            <div class="col-md-6 col-lg-4">
                              <div class="card">
                                <div class="card-body">
                                  <img src="{{ asset('assets/images/landing/tech-vuetify.svg') }}" alt="img" class="img-fluid" />
                                  <h4 class="mb-3 mt-2">Vue</h4>
                                  <p class="text-muted">Able Pro Vue stands out as a versatile and powerful - Vue with Vuetify dashboard
                                    combines modern design principles with
                                    robust functionality.</p>
                                  <a class="btn btn-light-dark mt-2" href="https://ableproadmin.com/vue/dashboard/default"
                                    target="_blank"><i class="ti ti-external-link"></i> Preview</a>
                                  <a class="btn btn-icon btn-light mt-2" target="_blank" data-bs-toggle="tooltip" disabled
                                    data-bs-placement="top" title="Click to Download Free Able Pro Dashboard Template"
                                    href="https://links.codedthemes.com/vYUWM"><i class="ti ti-brand-github"></i></a>
                            ...
                            <div class="col-md-6 col-lg-4">
                              <div class="card">
                                <div class="card-body">
                                  <img src="{{ asset('assets/images/landing/tech-l-v.svg') }}" alt="img" class="img-fluid" />
                                  ...
                                  <a class="btn btn-light-dark mt-2"
                                    href="https://phplaravel-207002-4524103.cloudwaysapps.com/build/dashboards/default" target="_blank"><i
                                      class="ti ti-external-link"></i> Preview</a>
                                  <a class="btn btn-icon btn-light mt-2" target="_blank" data-bs-toggle="tooltip" disabled
                                    data-bs-placement="top" title="Click to Download Free Able Pro Dashboard Template"
                                    href="https://links.codedthemes.com/vYUWM"><i class="ti ti-brand-github"></i></a>
                            ...
                            <div class="col-md-6 col-lg-4">
                              <div class="card">
                                <div class="card-body">
                                  <img src="{{ asset('assets/images/landing/tech-django.svg') }}" alt="img" class="img-fluid" />
                                  <h4 class="mb-3 mt-2">Django</h4>
                                  <p class="text-muted">Able Pro Django is a powerful dashboard template designed for developers. it offers
                                    an extensive collection of pre-built
                                    components for seamless web development.</p>
                                  <div class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Live Preview not available">
                                    <a class="btn btn-light-dark mt-2 disabled" href="#" disabled><i class="ti ti-external-link"></i>
                                      Preview</a>
                                  </div>
                                  <a class="btn btn-icon btn-light mt-2" target="_blank" data-bs-toggle="tooltip" disabled
                                    data-bs-placement="top" title="Click to Download Free Able Pro Dashboard Template"
                            ...
                            <div class="col-md-6 col-lg-4">
                              <div class="card">
                                <div class="card-body">
                                  <img src="{{ asset('assets/images/landing/tech-flask.svg') }}" alt="img" class="img-fluid" />
                                  <h4 class="mb-3 mt-2">Flask</h4>
                                  <p class="text-muted">Able Pro Flask is a versatile dashboard solution that offers a rich set of pre-built
                                    components to simplify web
                                    development.</p>
                                  <div class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Live Preview not available">
                                    <a class="btn btn-light-dark mt-2 disabled" href="#" disabled><i class="ti ti-external-link"></i>
                            ...
                            <div class="col-md-6 col-lg-4">
                              <div class="card">
                                <div class="card-body">
                                  <img src="{{ asset('assets/images/landing/tech-nodejs.svg') }}" alt="img" class="img-fluid" />
                                  <h4 class="mb-3 mt-2">NodeJS</h4>
                                  <p class="text-muted">Able Pro Node.js combines flexibility and functionality with a variety of pre-built
                                    components tailored for Node.js,
                                    which make it easier to develop.</p>
                                  <div class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Live Preview not available">
                                    <a class="btn btn-light-dark mt-2 disabled" href="#" disabled><i class="ti ti-external-link"></i>
                                      Preview</a>
                            ...
                            <div class="col-md-6 col-lg-4">
                              <div class="card">
                                <div class="card-body">
                                  <img src="{{ asset('assets/images/landing/tech-l-b.svg') }}" alt="img" class="img-fluid" />
                                  <h4 class="mb-3 mt-2">Laravel Bootstrap</h4>
                                  <p class="text-muted">Able Pro Laravel with Bootstrap provides a powerful set of tools and components,
                                    crafted specifically for Laravel, to
                                    simplify and accelerate your development process.</p>
                                  <div class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Live Preview not available">
                                    <a class="btn btn-light-dark mt-2 disabled" href="#" disabled><i class="ti ti-external-link"></i>
                                      Preview</a>
                            ...
                            <div class="col-md-6 col-lg-4">
                              <div class="card">
                                <div class="card-body">
                                  <img src="{{ asset('assets/images/landing/tech-svelteKit.svg') }}" alt="img" class="img-fluid" />
                                  <h4 class="mb-3 mt-2">SvelteKit</h4>
                                  <p class="text-muted">Able Pro Svelte provides an extensive toolkit and components, allowing you to build
                        ...
                        <div class="container title">
                          <div class="row justify-content-center text-center wow fadeInUp" data-wow-delay="0.2s">
                            <div class="col-md-8 col-xl-6">
                              ...
                              <p class="mb-0"> Able Pro caters to the needs of both developers and designers, whether they are beginners or
                                experts. </p>
                            </div>
                          </div>
                        </div>
                            ...
                            <div class="col-md-6 col-lg-6">
                              <div class="card h-100 mb-0">
                                <div class="card-body mt-2">
                                  ...
                                  <p class="text-muted"> Access all components of Able Pro in one place to make your development work
                                    easier. </p>
                                  <img class="pt-2" src="{{ asset('assets/images/landing/feature-components.png') }}" width="100%" />
                                  <div class="tech-link">
                                    <a class="btn btn-light-dark mt-3" href="elements/bc_alert.html" target="_blank">View All Components <i
                            ...
                            <div class="col-md-6 col-lg-6">
                              <div class="card h-100 mb-0">
                                <div class="card-body mt-2">
                                  ...
                                  <img class="pt-2" src="{{ asset('assets/images/landing/feature-documentation.png') }}" width="100%" />
                                  <a class="btn btn-light-dark mt-3" href="https://phoenixcoded.gitbook.io/able-pro/" target="_blank">Check
                        ...
                        <div class="container">
                          <div class="row justify-content-center text-center m-b-25">
                            <div class="col-md-10 col-xl-8">
                              <img class="" src="{{ asset('assets/images/landing/figma-light.png') }}" width="100%" />
                            </div>
                          </div>
                            ...
                            <div class="col-md-6 position-relative wow fadeInRight" data-wow-delay="0.4s">
                              <div class="owl-carousel owl-theme screen-slide img-app-moke">
                                <div class="item" data-hash="app_1">
                                  <img src="{{ asset('assets/images/landing/chat.png') }}" alt="img" class="img-fluid rounded" />
                                </div>
                                <div class="item" data-hash="app_2">
                                  <img src="{{ asset('assets/images/landing/e-commerce.png') }}" alt="img" class="img-fluid rounded" />
                                </div>
                                <div class="item" data-hash="app_3">
                                  <img src="{{ asset('assets/images/landing/mail.png') }}" alt="img" class="img-fluid rounded" />
                                </div>
                                <div class="item" data-hash="app_4">
                                  <img src="{{ asset('assets/images/landing/social.png') }}" alt="img" class="img-fluid rounded" />
                                </div>
                              </div>
                            </div>
                          </div>
