...
<head>
    ...
    <title>Login</title>
    <!-- Minimal CSS needed for the login UI -->
    <link rel="stylesheet" href="{{ asset('assets/css/plugins/bootstrap.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/css/style.css') }}" />
    <style>
        /* small override to center the card vertically */
                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="{{ route('login.post') }}">
                            ...
                            <div class="text-center small text-muted">Use your admin credentials to sign in.</div>
                        </form>
                    </div>
                </div>
