          ...
          <div class="card-body">
            <div class="text-end p-4 pb-sm-2">
              <a href="#" 
                 ...
                 data-bs-target="#lokasi-add-modal">
                <i class="ti ti-plus f-18"></i> Tambah Lokasi
              </a>
            </div>

            <div class="table-responsive">
              <table class="table table-hover" id="pc-dt-lokasi">
                <thead>
                  <tr>
                    <th>#</th>
                    <th>Nama Lokasi</th>
                        ...
                        <ul class="list-inline me-auto mb-0">
                          <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="Edit">
                            <a href="#" 
                               ...
                               data-bs-toggle="modal"
                               data-bs-target="#lokasi-edit-modal"
                          ...
                          <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="Delete">
                            <form action="{{ route('lokasis.destroy', $lokasi->id_lokasi) }}" method="POST" class="delete-form d-inline">
                              @csrf
                              @method('DELETE')
...
<!-- Modal Tambah -->
<div class="modal fade" id="lokasi-add-modal" tabindex="-1" aria-hidden="true">
...
<!-- Modal Edit -->
<div class="modal fade" id="lokasi-edit-modal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-md modal-dialog-centered">
    <div class="modal-content">
      <form id="lokasiEditForm" method="POST">
        @csrf
        @method('PUT')
        <div class="modal-header">
        ...
        <div class="modal-body">
          <div class="mb-3">
            <label class="form-label">Nama Lokasi</label>
            <input type="text" id="editNamaLokasi" name="nama_lokasi" class="form-control" required>
          </div>
        </div>
        <div class="modal-footer justify-content-between">
          <button type="button" class="btn btn-link-danger btn-pc-default" data-bs-dismiss="modal">Batal</button>
...
document.addEventListener('DOMContentLoaded', function () {
  const tableEl = document.querySelector('#pc-dt-lokasi');
  if (tableEl) {
  ...
  const editModal = document.getElementById('lokasi-edit-modal');
  editModal.addEventListener('show.bs.modal', function (event) {
    const button = event.relatedTarget;
    const id = button.getAttribute('data-id');
    const nama = button.getAttribute('data-nama');
    const form = editModal.querySelector('#lokasiEditForm');
    const inputNama = editModal.querySelector('#editNamaLokasi');
